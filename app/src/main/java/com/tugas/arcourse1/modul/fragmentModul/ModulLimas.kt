...
import kotlinx.android.synthetic.main.fragment_modul_balok.view.*
import kotlinx.android.synthetic.main.fragment_modul_balok.view.btn_modul
import kotlinx.android.synthetic.main.fragment_modul_limas.view.*
import kotlinx.android.synthetic.main.selesaimodul.view.*

class ModulLimas : Fragment() {
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        val view: View = inflater!!.inflate(R.layout.fragment_modul_limas, container, false)

        view.btn_modul.setOnClickListener { view ->
