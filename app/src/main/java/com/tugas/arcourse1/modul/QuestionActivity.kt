...
class QuestionActivity : AppCompatActivity() {
    ...
    fun setOptionStyle(){
        ...
        for(op in optionList){
            ...
            op.background= ContextCompat.getDrawable(this, R.drawable.bg_question_option)
    ...
    fun selectedOptionStyle(view: TextView, opt:Int){
        setOptionStyle()
        selectedOption=opt
        view.background= ContextCompat.getDrawable(this, R.drawable.bg_selected_question_option)
