...
import com.tugas.arcourse1.data.setDataBalok
import com.tugas.arcourse1.modul.ResultActivity
import kotlinx.android.synthetic.main.activity_question.*
import java.util.concurrent.TimeUnit

class QuestionBalokActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionList = setDataBalok.getQuestion()
            ...
            if (selectedOption != 0) {
                ...
                when {
                    currentPosition <= questionList!!.size -> {
                        ...
                        intent.putExtra(setDataBalok.score, score.toString())
